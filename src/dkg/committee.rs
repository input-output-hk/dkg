...
pub type DistributedKeyGeneration<G: PrimeGroupElement> = MemberState1<G>;
...
/// shares.
pub(crate) type IndexedEncryptedShares<G: PrimeGroupElement> = (usize, HybridCiphertext<G>, HybridCiphertext<G>);
...
impl<G: PrimeGroupElement> MemberState1<G> {
    ...
    pub fn to_phase_2(
        ...
        for fetched_data in members_state {
            ...
            {
                let index_pow = <G::CorrespondingScalar as Scalar>::from_u64(self.owner_index as u64)
                    .exp_iter()
...
mod tests {
    ...
    fn valid_phase_2() {
        ...
        let mut shared_string =
            b"Example of a shared string.".to_owned();
